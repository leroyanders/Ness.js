...
function Home(props) {
  ...
  return __jsx(nessapp_next_ui__WEBPACK_IMPORTED_MODULE_2__["Page"], {
    ...
    className: "p-0 bg-slate-0 rounded-md ml-9 border-r border-slate-200 rounded-r-none",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 32,
    ...
    className: "text-slate-200 rounded-lg p-3 px-4 text-[15px] pr-0",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 34,
    ...
    className: "bg-slate-100 rounded-md p-3 text-slate-600 px-4 text-[15px] border-r-4 border-blue-400 rounded-r-none",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 35,
    ...
    className: "text-slate-200 rounded-lg p-3 px-4 text-[15px] pr-0 rounded-r-none",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 89,
  ...
  }, "You do not have to buy various solutions, development and assembly of your application takes place in real time using the popular HOT Module Replacement(HMD) and also saves time writing styling. As practice has shown, writing a complex application takes less than a week."))))), __jsx("a", {
    href: "#",
...
//# sourceMappingURL=main.e07afee6361222599446.hot-update.js.map