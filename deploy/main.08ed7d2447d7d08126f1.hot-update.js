...
function Home(props) {
  ...
  return __jsx(nessapp_next_ui__WEBPACK_IMPORTED_MODULE_2__["Page"], {
    ...
    className: "p-2 bg-slate-100 rounded-md ml-9",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 33,
    ...
    className: "bg-slate-200 rounded-md p-3 px-4 text-[15px]",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 34,
    ...
    className: "ml-10 rounded-lg w-[50%] p-10",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 46,
    ...
    className: "mb-10 font-light border-b border-gray-200 dark:border-gray-700",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 47,
    ...
    type: "button",
    className: "flex items-center justify-between w-full py-5 font-medium text-left border-b border-gray-200 dark:border-gray-700 dark:bg-gray-900 text-gray-900 dark:text-white",
...
//# sourceMappingURL=main.08ed7d2447d7d08126f1.hot-update.js.map