...
function Home(props) {
  ...
  return __jsx(nessapp_next_ui__WEBPACK_IMPORTED_MODULE_2__["Page"], {
    ...
    className: "bg-slate-100 p-4 px-4 rounded-full ml-2 text-slate-500",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 30,
    ...
    className: 'py-2 px-3 bg-indigo-500 text-white text-sm font-semibold rounded-full focus:outline-none',
...
//# sourceMappingURL=main.340299f66236ef717fff.hot-update.js.map