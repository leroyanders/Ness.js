...
function Home(props) {
  ...
  return __jsx(nessapp_next_ui__WEBPACK_IMPORTED_MODULE_2__["Page"], {
    ...
    className: "p-0 rounded-md border-r-4 border-indigo-500",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 32,
    ...
    className: "ml-10 bg-slate-100 rounded-lg w-full p-10",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 44,
...
//# sourceMappingURL=main.c871c1ab2cdd7327f1dc.hot-update.js.map