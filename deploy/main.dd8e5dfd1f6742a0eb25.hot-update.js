...
function Header(props) {
  return __jsx("header", {
    ...
    type: "search",
    id: "search",
    className: "block p-2 pl-10 text-sm text-gray-900 bg-gray-100 rounded-md border border-gray-200 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500",
    placeholder: "Search",
    required: true,
    __self: this,
    __source: {
...
//# sourceMappingURL=main.dd8e5dfd1f6742a0eb25.hot-update.js.map