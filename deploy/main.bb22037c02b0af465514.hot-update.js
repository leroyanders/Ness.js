...
function Header(props) {
  return __jsx("header", {
    ...
    className: "mr-20 justify-content",
    role: "presentation",
    __self: this,
    __source: {
      fileName: _jsxFileName,
    ...
    className: "text-[20px] inline-block p-4 rounded-t-lg border-b-2 border-transparent hover:text-gray-600 dark:hover:text-gray-300 pointer text-[#4277ad] flex",
    id: "home",
    ...
    src: "https://user-images.githubusercontent.com/106757584/185131412-5379089e-1725-42a9-a13a-74003a03d07d.png",
    className: "w-8 w-8",
    __self: this,
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=main.bb22037c02b0af465514.hot-update.js.map