...
function Home(props) {
  ...
  return __jsx(nessapp_next_ui__WEBPACK_IMPORTED_MODULE_2__["Page"], {
    ...
    className: "block p-2 pl-10 text-sm text-gray-900 bg-gray-100 rounded-lg border border-gray-200 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 p-2 bg-slate-0 rounded-md ml-9",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 33,
    ...
    className: "bg-slate-200 rounded-lg p-3 px-4 text-[15px]",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 34,
  ...
  }, "Development experience"))), __jsx("ul", {
    className: "p-2 bg-slate-50 rounded-md ml-9 mt-5",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 44,
    ...
    className: "border-r-2 border-slate-100 h-full",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 50,
  ...
  }, "Flowbite is an open-source library of interactive components built on top of Tailwind CSS including buttons, dropdowns, modals, navbars, and more."), __jsx("p", {
  ...
  }, "get started"), " and start developing websites even faster with components on top of Tailwind CSS."))), __jsx("h2", {
  ...
  }, "Is there a Figma file available?"), __jsx("svg", {
    "data-accordion-icon": "",
  ...
  }, "Flowbite is first conceptualized and designed using the Figma software so everything you see in the library has a design equivalent in our Figma file."), __jsx("p", {
    className: "text-gray-500 dark:text-gray-400",
    __self: this,
    __source: {
      fileName: _jsxFileName,
  ...
  }, "Figma design system"), " based on the utility classes from Tailwind CSS and components from Flowbite."))), __jsx("h2", {
  ...
  }, "What are the differences between Flowbite and Tailwind UI?"), __jsx("svg", {
    "data-accordion-icon": "",
    className: "w-6 h-6 shrink-0",
    fill: "currentColor",
    viewBox: "0 0 20 20",
  ...
  }, "The main difference is that the core components from Flowbite are open source under the MIT license, whereas Tailwind UI is a paid product. Another difference is that Flowbite relies on smaller and standalone components, whereas Tailwind UI offers sections of pages."), __jsx("p", {
    className: "mb-2 text-gray-500 dark:text-gray-400",
    __self: this,
    __source: {
      fileName: _jsxFileName,
  ...
  }, "However, we actually recommend using both Flowbite, Flowbite Pro, and even Tailwind UI as there is no technical reason stopping you from using the best of two worlds."), __jsx("p", {
    className: "mb-2 text-gray-500 dark:text-gray-400",
    __self: this,
    __source: {
      fileName: _jsxFileName,
  ...
  }, "Learn more about these technologies:"), __jsx("ul", {
    className: "pl-5 text-gray-500 list-disc dark:text-gray-400",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 92,
...
//# sourceMappingURL=main.f323ee164e64f91b17b2.hot-update.js.map