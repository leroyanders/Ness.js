...
function Home(props) {
  ...
  return __jsx(nessapp_next_ui__WEBPACK_IMPORTED_MODULE_2__["Page"], {
    ...
    className: "p-0 bg-slate-0 rounded-md ml-9",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 33,
    ...
    className: "bg-slate-100 text-slate-600 rounded-lg p-3 px-4 text-[15px]",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 34,
    ...
    className: "rounded-md p-3 text-slate-400 px-4 text-[15px]",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 39,
...
//# sourceMappingURL=main.460ff449d221788b04a3.hot-update.js.map