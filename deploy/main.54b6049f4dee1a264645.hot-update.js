...
function QuickStart(props) {
  ...
  }, "$ npm generate page ./pages/ExamplePage"), __jsx("code", {
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 239,
  ...
  }, "$ npm generate hook ./hooks/ExampleHook"), __jsx("code", {
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 240,
  ...
  }, "$ npm generate service ./services/ExampleService"), __jsx("code", {
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 241,
  ...
  }, "$ npm generate component ./pages/ExampleComponent")))), __jsx("pre", {
    className: "text-[14px] bg-slate-100 rounded-lg p-5 mb-2 text-slate-600",
    __self: this,
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=main.54b6049f4dee1a264645.hot-update.js.map