...
function QuickStart(props) {
  ...
  return __jsx(nessapp_next_ui__WEBPACK_IMPORTED_MODULE_3__["Page"], {
    ...
    className: "text-[14px] bg-slate-100 rounded-lg p-5 mb-2",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 125,
    ...
    className: "p-4 border-l-4 border-slate-100 my-5 py-2 font-weight-500",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 139,
  ...
  }, "Note that we prefer using npx, because of latest version"), __jsx("pre", {
    className: "text-[14px] bg-slate-100 rounded-lg p-5",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 142,
  ...
  }, "npm uninstall -g create-razzle-app"), "or", __jsx("code", {
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 154,
...
//# sourceMappingURL=main.6d45e04b7cd505b3300b.hot-update.js.map