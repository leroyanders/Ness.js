...
function Header(props) {
  return __jsx("header", {
    ...
    className: "text-white absolute right-2.5 bottom-1.2 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-1 py-1 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 30,
...
//# sourceMappingURL=main.d52b0b9366b3b9732d39.hot-update.js.map