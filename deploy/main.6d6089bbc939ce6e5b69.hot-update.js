...
function QuickStart(props) {
  ...
  return __jsx(nessapp_next_ui__WEBPACK_IMPORTED_MODULE_3__["Page"], {
    ...
    className: "bg-slate-100 rounded-lg p-5 mb-2",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 125,
  ...
  }, "$ npm install -g create-ness-app@latest")))), __jsx("div", {
  ...
  }, "$ npm install -g create-ness-app")), __jsx("div", {
  ...
  }, "$ npx create-ness-app")))), __jsx("pre", {
    className: "bg-slate-100 rounded-lg p-5",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 150,
...
//# sourceMappingURL=main.6d6089bbc939ce6e5b69.hot-update.js.map