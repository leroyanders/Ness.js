...
function Home(props) {
  ...
  return __jsx(nessapp_next_ui__WEBPACK_IMPORTED_MODULE_2__["Page"], {
    ...
    className: "text-slate-600 rounded-lg p-3 px-4 text-[15px]",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 33,
    ...
    className: "bg-slate-100 rounded-md p-3 text-slate-400 px-4 text-[15px]",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 34,
...
//# sourceMappingURL=main.3d047246409cd6c0619e.hot-update.js.map