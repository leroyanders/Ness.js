...
function Home(props) {
  ...
  return __jsx(nessapp_next_ui__WEBPACK_IMPORTED_MODULE_2__["Page"], {
    ...
    className: "rounded-md p-2 text-slate-500 text-[15px]",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 37,
    ...
    type: "button",
    class: "flex items-center justify-between w-full py-5 font-medium text-left border-b border-gray-200 dark:border-gray-700 dark:bg-gray-900 text-gray-900 dark:text-white",
...
//# sourceMappingURL=main.3f0a99678b5ac0c706ba.hot-update.js.map