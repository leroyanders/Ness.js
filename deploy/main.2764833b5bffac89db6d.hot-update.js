...
function Header(props) {
  return __jsx("header", {
    ...
    className: "text-[18px] inline-block p-4 rounded-t-lg border-b-2 border-transparent hover:text-gray-600 dark:hover:text-gray-300 pointer text-[#4277ad]",
    id: "home",
    ...
    className: "text-[12px] text-state-500",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 11,
  ...
  }, "Newest Experience of Server Side development.")), __jsx("li", {
    className: "mr-2",
    role: "presentation",
    __self: this,
    __source: {
...
//# sourceMappingURL=main.2764833b5bffac89db6d.hot-update.js.map