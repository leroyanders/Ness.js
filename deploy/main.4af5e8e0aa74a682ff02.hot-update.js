...
function Home(props) {
  return __jsx(nessapp_next_ui__WEBPACK_IMPORTED_MODULE_3__["Page"], {
    ...
    className: "h-[100%] p-0 bg-slate-0 rounded-md ml-9 border-r border-slate-200 rounded-r-none sticky xs:w-[100%] xs:ml-0",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 32,
    ...
    className: "active text-slate-200 rounded-lg p-3 px-4 text-[15px] xs:p-0",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 34,
...
//# sourceMappingURL=main.4af5e8e0aa74a682ff02.hot-update.js.map