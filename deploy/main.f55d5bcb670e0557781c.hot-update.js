...
function Home(props) {
  ...
  return __jsx(nessapp_next_ui__WEBPACK_IMPORTED_MODULE_2__["Page"], {
    ...
    className: "bg-slate-200 rounded-md p-3 px-4 text-[16px]",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 34,
    ...
    className: "rounded-md p-3 text-slate-500 px-4 text-[16px]",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 37,
...
//# sourceMappingURL=main.f55d5bcb670e0557781c.hot-update.js.map