...
function Home(props) {
  ...
  return __jsx(nessapp_next_ui__WEBPACK_IMPORTED_MODULE_2__["Page"], {
    ...
    className: "bg-slate-100 rounded-md p-3 text-slate-600 px-4 text-[15px] border-r-4 border-blue-400",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 35,
...
//# sourceMappingURL=main.92941ae1a23d9fa2d4be.hot-update.js.map