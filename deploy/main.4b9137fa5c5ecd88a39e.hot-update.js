...
function Home(props) {
  ...
  return __jsx(nessapp_next_ui__WEBPACK_IMPORTED_MODULE_2__["Page"], {
    ...
    className: "p-2 bg-slate-50 rounded-md ml-9",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 33,
    ...
    className: "bg-slate-200 border-l-2 border-blue-200 rounded-md p-3 px-4 text-[15px]",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 34,
...
//# sourceMappingURL=main.4b9137fa5c5ecd88a39e.hot-update.js.map