...
function Home(props) {
  ...
  return __jsx(nessapp_next_ui__WEBPACK_IMPORTED_MODULE_2__["Page"], {
    ...
    class: "border-gray-300 text-slate-500 absolute right-1.5 m-auto hover:bg-slate-200 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-1 py-1 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 37,
  ...
  }, "You do not have to buy various solutions, development and assembly of your application takes place in real time using the popular HOT Module Replacement(HMD) and also saves time writing styling. As practice has shown, writing a complex application takes less than a week.")))))))))));
}
...
//# sourceMappingURL=main.5348f4a2f9aef1c51a09.hot-update.js.map