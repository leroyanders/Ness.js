...
function Home(props) {
  ...
  return __jsx(nessapp_next_ui__WEBPACK_IMPORTED_MODULE_2__["Page"], {
  ...
  }, "Awesome React framework!")), __jsx("h3", {
  ...
  }, "Thank you for installing!")), __jsx("div", {
    ...
    className: "bg-blue-500 hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded",
...
//# sourceMappingURL=main.fb7b9fbc1ba8331ee5c5.hot-update.js.map