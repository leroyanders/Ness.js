...
function Documentation(props) {
  return __jsx(nessapp_next_ui__WEBPACK_IMPORTED_MODULE_3__["Page"], {
    ...
    className: "h-[100%] p-0 bg-slate-0 rounded-md ml-9 border-r border-slate-200 rounded-r-none sticky xs:w-[100%] xs:ml-0 xs:m-4 xs:bg-slate-50",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 32,
    ...
    className: "ml-10 w-[50%] p-10 pt-0 xs:ml-0 xs:w-[100%]",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 114,
  ...
  }, "Documentation will be available later, we are sorry.(coming soon)")), __jsx("div", {
    className: "mt-10",
    __self: this,
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=main.bd9351f3d0b61e5c1055.hot-update.js.map