...
function Header(props) {
    ...
    return (
        <header className="sticky">
            <div className="p-[12px] text-center bg-[#2a425c] text-white xs:text-[12px] xs:p-[13px]">
            ...
            <div className="mb-4 border-b border-gray-200 dark:border-gray-700 px-10 xs:px-2">
                <div className="flex">
                    <div className="flex w-[33%]">
                        <ul className="flex flex-wrap -mb-px text-sm font-medium text-center" id="myTab" data-tabs-toggle="#myTabContent" role="tablist">
                            <li className="mr-20 justify-content flex" role="presentation">
                                ...
                                <span className="text-[13px] text-slate-500 my-auto xs:hidden sm:hidden">
                                    Newest Experience of Server Side development.
                                </span>
                            </li>
                        </ul>
                    </div>
                    <div className="flex w-[33%] xs:hidden sm:hidden">
                        <ul className="flex flex-wrap -mb-px text-sm font-medium text-center" id="myTab" data-tabs-toggle="#myTabContent" role="tablist">
                    ...
                    <div className="flex w-[33%] xs:ml-auto xs:w-[67%] sm:ml-auto sm:w-[67%]">
                        <nav className="mt-1.5 ml-auto">
                            <div className="flex">
                                <nav className="mr-5 flex">
                                    ...
                                    <button disabled type="button" className="xs:hidden text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5 inline-flex items-center"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" className="w-5 h-5"><path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z"></path></svg></button>
                                </nav>
                                <form>   
